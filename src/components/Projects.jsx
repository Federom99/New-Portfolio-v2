...
const Projects = () => {
  ...
  return (
    <>
      ...
      >
        Here you can see my projects. In each of them it was to continue
        improving my technical skills. Some were for the bootcamp and others
        were personal projects. Also, you can see the code by accessing the
        repo, or else a demonstration of what the project is about.
      </p>
